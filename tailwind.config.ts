	...
	safelist: [
		...
		// },
		{
			pattern:
				...
				/bg-(zinc|red|amber|lime|emerald|sky|blue|indigo|violet)-(50|100|200|300|400|500|600|700|800|900|950)$/,
			variants: ['hover', 'active', 'checked', 'indeterminate'],
		},
		{
			pattern:
				// /bg-(slate|gray|zinc|neutral|stone|red|orange|amber|yellow|lime|green|emerald|teal|cyan|sky|blue|indigo|violet|purple|fuchsia|pink|rose)-(50|100|200|300|400|500|600|700|800|900)$/,
				/bg-(zinc|red|amber|lime|emerald|sky|blue|indigo|violet)-(50|100|200|300|400|500|600|700|800|900|950)\/(10)$/,
		},
		// {
		...
		// },
		{
			pattern:
				...
				/border-(zinc|red|amber|lime|emerald|sky|blue|indigo|violet)-(50|100|200|300|400|500|600|700|800|900|950)$/,
		...
		},
		{
			pattern:
				...
				/border-(zinc|red|amber|lime|emerald|sky|blue|indigo|violet)-(50|100|200|300|400|500|600|700|800|900|950)\/(50)$/,
			variants: ['hover', 'active'],
		},
		{
			pattern:
				...
				/text-(zinc|red|amber|lime|emerald|sky|blue|indigo|violet)-(50|100|200|300|400|500|600|700|800|900|950)$/,
